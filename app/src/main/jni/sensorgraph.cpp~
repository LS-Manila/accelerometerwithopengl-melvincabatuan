...
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_init(JNIEnv *env, jclass type, jobject assetManager) {
    (void)type;
...
JNIEXPORT void JNICALL
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_surfaceCreated(JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
...
JNIEXPORT void JNICALL
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_surfaceChanged(JNIEnv *env, jclass type, jint width,
                                                           jint height) {
    (void)env;
    (void)type;
...
JNIEXPORT void JNICALL
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_drawFrame(JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    gSensorGraph.update();
    gSensorGraph.render();
...
JNIEXPORT void JNICALL
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_pause(JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    gSensorGraph.pause();
}
...
JNIEXPORT void JNICALL
Java_ph_edu_dlsu_sensor_1graph_SensorGraphJNI_resume(JNIEnv *env, jclass type) {
    (void)env;
    (void)type;
    gSensorGraph.resume();
}
